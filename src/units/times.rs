...
time! {
    ...
    pub static MINUTE = (0x3cea90d3, 60u32, 1u32), |f, _| f.write_str("mn")
}
time! {
    /// An hour `H` (`3600s`) in [Unit::Second].
    pub static HOUR = (0x8884f852, 3600u32, 1u32), |f, _| f.write_str("H")
}
time! {
...
time! {
    ...
    pub static YEAR = (0xe923ce05, 3147113076u32, 100u32), |f, _| f.write_str("yr")
}
time! {
    /// A Century (`10yr`) in [Unit::Second] defined as `10` times [YEAR].
    pub static DECADE = (0xbed4a84b, 3147113076u32, 10), |f, pluralize| if pluralize {
        f.write_str("decades")
    } else {
        f.write_str("decade")
    }
...
time! {
    ...
    pub static CENTURY = (0x8efe5bbc, 3147113076u32, 1), |f, pluralize| if pluralize {
...
time! {
    ...
    pub static MILLENIUM = (0x0d2818da, 31471130760u64, 1), |f, pluralize| if pluralize {
