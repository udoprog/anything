...
//! [<img alt="build status" src="https://img.shields.io/github/workflow/status/udoprog/anything/CI/master?style=for-the-badge" height="20">](https://github.com/udoprog/anything/actions?query=branch%3Amaster)
//!
